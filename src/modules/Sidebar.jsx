...
export default function Sidebar({
  onEditAtivos = () => {},
  onZerarTudo = () => {},   // ← mudou de onResetAll para onZerarTudo
  onNavigate = () => {},
  currentView = "",
}) {
  return (
    <aside className="fixed left-0 top-0 w-48 h-screen bg-slate-900 text-white flex flex-col justify-between p-4 border-r border-slate-700 select-none">
      ...
      <nav className="flex flex-col gap-3 text-base font-medium tracking-wide">
        ...
        <button
          onClick={onZerarTudo}   // ← agora chama a função que apaga TUDO do Supabase
      ...
      <nav className="flex flex-col gap-3 text-base font-medium tracking-wide">
        <button
          ...
          className={`flex flex-col items-center gap-1 transition hover:text-yellow-400 ${currentView === "dashboard" ? "text-yellow-400" : "text-slate-100"}`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 transition hover:text-emerald-400 ${currentView === "cursos-dashboard" ? "text-emerald-400" : "text-slate-100"}`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 transition hover:text-orange-500 ${currentView === "carteira" ? "text-orange-500" : "text-slate-100"}`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 transition hover:text-red-400 ${currentView === "despesas" ? "text-red-400" : "text-slate-100"}`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 transition hover:text-pink-400 ${currentView === "relatorios" ? "text-pink-400" : "text-slate-100"}`}
        >
