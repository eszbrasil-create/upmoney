...
export default function CardEvolucao({ columns = [], rows = [] }) {
  ...
  const MAX_BAR_HEIGHT = 260; // agora ocupa o card mas não estoura
  ...
  return (
    <div className="rounded-3xl bg-slate-800/70 border border-white/10 shadow-lg p-4 w-[590px] flex flex-col">
      ...
      {/* 🔥 AQUI — altura fixa, não expande mais */}
      <div className="h-[345px] rounded-2xl border border-white/10 bg-slate-900/80 px-3 pt-3 pb-2 overflow-x-auto overflow-y-hidden flex items-end">
