...
export default function CardEvolucao({ columns = [], rows = [] }) {
  ...
  return (
    <div className="rounded-3xl bg-slate-800/70 border border-white/10 shadow-lg p-4 w-[600px] h-[415px] overflow-hidden shrink-0">
      {/* HEADER */}
      ...
      {/* ÁREA DO GRÁFICO */}
      <div className="h-[320px] rounded-2xl border border-white/10 bg-slate-900/80 px-3 pt-3 pb-6 overflow-x-auto overflow-y-hidden">
