// src/pages/CashControlHome.jsx
// Página full-screen de apresentação da ferramenta CashControl
    ...
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100">
      ...
      <header className="sticky top-0 z-40 bg-[#020617] text-white/95 border-b border-slate-800/60">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          {/* Lado direito: Login + ícones sociais */}
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16 grid md:grid-cols-2 gap-10 items-center">
            ...
            <div>
              <p className="text-emerald-300 text-xs font-semibold tracking-[0.2em] uppercase mb-3">
                Ferramenta CashControl
              </p>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-slate-50">
                Controle seu patrimônio{" "}
                <span className="text-emerald-300">de forma simples e visual</span>
              </h1>

              <p className="mt-4 text-sm sm:text-base text-slate-300 max-w-xl">
                O CashControl é a ferramenta que usamos no seu painel:
                evolução mês a mês, distribuição por ativos, gráficos,
                relatórios e uma visão clara da sua construção de patrimônio.
              </p>

              <ul className="mt-5 space-y-2 text-sm text-slate-300">
                <li>• Registre e acompanhe patrimônio por mês.</li>
                <li>• Veja a evolução em gráficos claros e intuitivos.</li>
                <li>• Faça testes, simulações e organize seus objetivos.</li>
              </ul>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center rounded-xl bg-emerald-500 px-5 py-3 font-semibold text-slate-950 shadow-lg shadow-emerald-500/30 hover:bg-emerald-400"
                >
                  Acessar versão CashControl
                </button>

                <a
                  href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
                    "Olá! Quero saber mais sobre o acesso à ferramenta CashControl."
                  )}`}
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-xl border border-slate-600 px-4 py-2.5 text-sm font-medium text-slate-200 hover:border-emerald-400 hover:text-emerald-300"
                >
                  <IconWhatsApp className="h-5 w-5" />
                  Falar sobre planos de acesso
                </a>
              </div>
            </div>

            {/* Coluna com card / features */}
              ...
              <div className="rounded-2xl border border-slate-700/80 bg-slate-900/70 p-5 shadow-2xl shadow-emerald-500/10">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h2 className="text-sm font-semibold text-slate-100">
                      O que você encontra no CashControl
                    </h2>
                    <p className="text-xs text-slate-400">
                      Uma visão prática do que já está no painel
                    </p>
                  </div>
                ...
                <ul className="space-y-3 text-sm">
                  <li className="flex gap-3">
                    <div className="mt-0.5 h-6 w-6 rounded-full bg-emerald-500/20 flex items-center justify-center text-[11px] font-bold text-emerald-300">
                      1
                    </div>
                    <div>
                      <p className="font-semibold text-slate-100">
                        Registro mensal do patrimônio
                      </p>
                      <p className="text-xs text-slate-400">
                        Você lança seus ativos por categoria e acompanha a
                        evolução mês a mês em uma linha do tempo visual.
                      </p>
                    </div>
                  </li>
                  ...
                  <li className="flex gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-slate-100">
                        Gráficos e participação por ativo
                      </p>
                      <p className="text-xs text-slate-400">
                        Veja quais ativos mais pesam na sua carteira e como
                  ...
                  <li className="flex gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-slate-100">
                        Versão educacional e evolutiva
                      </p>
                      <p className="text-xs text-slate-400">
                        O CashControl começa simples, mas já está preparado
                        para crescer com novas funções, alertas e integrações.
                      </p>
                    </div>
                  </li>
                </ul>
                ...
                <div className="mt-5 rounded-xl border border-slate-700 bg-slate-900/80 px-3 py-2 text-[11px] text-slate-300">
                  <p>
                    ...
                    você consegue enxergar o filme completo do seu patrimônio —
                    não só o saldo de hoje, mas a história que está construindo.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="mt-10 bg-[#020617] text-white/95 border-t border-slate-800/60">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="mt-6 text-xs text-white/70">
            Meu Patrimônio — CashControl • Acompanhe sua evolução patrimonial de
            forma simples, visual e consciente.
          </p>
        </div>
      </footer>
    </div>
