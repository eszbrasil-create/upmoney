// src/pages/SaidaFiscal.jsx
// Página full-screen de Saída Fiscal, com layout escuro e cabeçalho igual ao da Landing
...
export default function SaidaFiscal({ onNavigate }) {
  const WHATSAPP_NUMBER = "5585999999999";

  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100">
      {/* Header igual ao da Landing, adaptado para fundo escuro */}
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16 grid md:grid-cols-2 gap-10 items-center">
            ...
            <div>
              <p className="text-emerald-300 text-xs font-semibold tracking-[0.2em] uppercase mb-3">
                Saída Fiscal Inteligente
              </p>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-slate-50">
                Organize sua saída fiscal{" "}
                <span className="text-emerald-300">sem perder o controle</span>
              </h1>

              <p className="mt-4 text-sm sm:text-base text-slate-300 max-w-xl">
                Planejamento para morar fora do Brasil, cuidar da sua
                tributação, entender o impacto nos seus investimentos e manter
                sua carteira alinhada com os novos objetivos de vida.
              </p>

              <ul className="mt-5 space-y-2 text-sm text-slate-300">
                <li>• Entenda quando e como realizar sua saída definitiva.</li>
                <li>• Veja o impacto em dividendos, FIIs e renda no exterior.</li>
                <li>• Monte um plano claro para patrimônio Brasil x Exterior.</li>
              </ul>

              <div className="mt-8 flex flex-wrap items-center gap-3">
                <a
                  href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
                    "Olá! Quero falar sobre planejamento de saída fiscal com o Meu Patrimônio."
                  )}`}
                  target="_blank"
                  rel="noreferrer"
                ...
                >
                  ...
                  Quero organizar minha saída fiscal
                </a>
              ...
              <div className="rounded-2xl border border-slate-700/80 bg-slate-900/70 p-5 shadow-2xl shadow-emerald-500/10">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h2 className="text-sm font-semibold text-slate-100">
                      Jornada de Saída Fiscal
                    </h2>
                    <p className="text-xs text-slate-400">
                      Uma visão clara em 3 etapas
                    </p>
                  </div>
                ...
                <ol className="space-y-3 text-sm">
                  <li className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400">
                        Entendemos como está seu patrimônio, fontes de renda e
                        planos de mudança.
                      </p>
                    </div>
                  </li>
                  ...
                  <li className="flex gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-slate-100">
                        Plano de saída fiscal e investimentos
                      </p>
                      <p className="text-xs text-slate-400">
                        Organização entre Brasil e exterior, impacto em
                        dividendos e estrutura de contas.
                      </p>
                    </div>
                  </li>
                  ...
                  <li className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400">
                        Passo a passo prático para a mudança, evitando
                        surpresas fiscais e mantendo clareza do patrimônio.
                      </p>
                    </div>
                  </li>
                </ol>
                ...
                <div className="mt-5 rounded-xl border border-slate-700 bg-slate-900/80 px-3 py-2 text-[11px] text-slate-300">
                  <p>
                    ...
                    você não precisa ser especialista em imposto de renda ou
                    tributação internacional — só precisa de um plano claro e
                    organizado.
                  </p>
                </div>
              </div>
      ...
      <footer className="mt-10 bg-[#020617] text-white/95 border-t border-slate-800/60">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="mt-6 text-xs text-white/70">
            Meu Patrimônio — Educação, planejamento e controle financeiro para
