// src/pages/Landing.jsx → VERSÃO FINAL COM YOUTUBE OFICIAL E TUDO PERFEITO
...
export default function Landing({ onNavigate }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <header className="sticky top-0 z-50 bg-slate-900/95 backdrop-blur border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* YOUTUBE OFICIAL COM PLAY BRANCO */}
      ...
      {/* HERO FINAL – BADGE VERMELHO GIGANTE */}
