...
// Página full-screen de Últimas notícias, com mesmo layout da Saída Fiscal
...
export default function Noticias({ onNavigate }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100">
      {/* Header idêntico ao da Saída Fiscal, com 'Últimas notícias' ativo */}
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16 grid md:grid-cols-2 gap-10 items-start">
            ...
            <div>
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-slate-50">
                Últimas notícias{" "}
                <span className="text-emerald-300">para guiar suas decisões</span>
              </h1>

              <p className="mt-4 text-sm sm:text-base text-slate-300 max-w-xl">
                Uma curadoria de notícias, movimentos de mercado e mudanças
                importantes em renda fixa, FIIs, ações e investimentos no
                exterior — sempre com foco no investidor pessoa física.
              </p>

              <ul className="mt-5 space-y-2 text-sm text-slate-300">
                <li>• Resumos objetivos, sem “economês”.</li>
                <li>
                  • Foco em como cada notícia pode impactar seu patrimônio e seus
                  proventos.
                </li>
                <li>• Destaques para oportunidades e pontos de atenção.</li>
              </ul>

              <div className="mt-8 flex flex-wrap items-center gap-3">
                <a
                  href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
                    "Olá! Quero receber o resumo semanal de notícias do Meu Patrimônio."
                  )}`}
                  target="_blank"
                  rel="noreferrer"
                ...
                <button className="inline-flex items-center rounded-xl border border-slate-600 px-4 py-2.5 text-sm font-medium text-slate-200 hover:border-emerald-400 hover:text-emerald-300">
                  Ver linha do tempo recente
                </button>
              </div>
            </div>

            {/* Coluna direita: cards de notícias (placeholders) */}
            <div className="md:pl-4 space-y-4">
              {/* Card 1 */}
              <div className="rounded-2xl border border-slate-700/80 bg-slate-900/70 p-4 shadow-2xl shadow-emerald-500/10">
                ...
                <h2 className="text-sm font-semibold text-slate-50">
                  Fundos imobiliários anunciam calendário de proventos
                </h2>
                <p className="mt-1 text-xs text-slate-300">
                  Resumo dos principais FIIs que divulgaram dividendos, valores
                  por cota e datas de pagamento — para você atualizar seu
                  CashControl com segurança.
                </p>
                <button className="mt-3 text-xs font-semibold text-emerald-300 hover:text-emerald-200">
              ...
              <div className="rounded-2xl border border-slate-700/80 bg-slate-900/70 p-4 shadow-2xl shadow-emerald-500/10">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-[11px] font-semibold text-sky-300 uppercase tracking-wide">
                    Renda Fixa & Juros
                  </span>
                  <span className="text-[11px] text-slate-400">Esta semana</span>
                </div>
                <h2 className="text-sm font-semibold text-slate-50">
                  Mudanças na taxa de juros e impacto na sua carteira
                </h2>
                <p className="mt-1 text-xs text-slate-300">
                  Explicamos em linguagem simples como a última decisão de juros
                  pode afetar títulos prefixados, IPCA+ e sua estratégia de
                  acúmulo de patrimônio.
                </p>
                <button className="mt-3 text-xs font-semibold text-emerald-300 hover:text-emerald-200">
                  Entender impacto na prática →
                </button>
              </div>
              ...
              <div className="rounded-2xl border border-slate-700/80 bg-slate-900/70 p-4 shadow-2xl shadow-emerald-500/10">
                ...
                <h2 className="text-sm font-semibold text-slate-50">
                  Dólar, investimentos fora e planos para quem mora no Brasil
                </h2>
                <p className="mt-1 text-xs text-slate-300">
                  Panorama rápido sobre câmbio, ETFs lá fora e o que observar
                  antes de enviar recursos para o exterior.
                </p>
                <button className="mt-3 text-xs font-semibold text-emerald-300 hover:text-emerald-200">
                  Ver próximos destaques →
                </button>
              </div>
            </div>
          </div>
      ...
      <footer className="mt-10 bg-[#020617] text-white/95 border-t border-slate-800/60">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="mt-6 text-xs text-white/70">
            Meu Patrimônio — Conteúdo informativo. Não constitui recomendação
            de investimento.
          </p>
        </div>
      </footer>
