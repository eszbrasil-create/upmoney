...
import { Shield, FileDown, CheckCircle2 } from "lucide-react";
...
const LS_KEY_CURSOS = "cc_curso_previdencia_privada_v1";

// id único do curso no Supabase
const COURSE_ID = "previdencia_privada";

export default function CursoPrevidencia({ onNavigate = () => {} }) {
  ...
  const MODULOS = useMemo(
    () => [
      {
        id: 1,
        titulo: "Módulo Completo — Previdência Privada (PGBL vs VGBL, taxas e tributação)",
        pdf: "/pdfs/Modulo-Previdencia-Privada.pdf",
      },

      // Quando você tiver mais PDFs, é só duplicar:
      // { id: 2, titulo: "Regimes de tributação (Progressivo vs Regressivo)", pdf: "/pdfs/pp_modulo02.pdf" },
      // { id: 3, titulo: "Como escolher: taxa de carregamento, administração e performance", pdf: "/pdfs/pp_modulo03.pdf" },
      // { id: 4, titulo: "Estratégia de longo prazo e aposentadoria", pdf: "/pdfs/pp_modulo04.pdf" },
    ],
    []
  );
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-slate-300 mt-1">
              Planejamento de longo prazo, benefícios fiscais e escolhas inteligentes.
            </p>
          </div>
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    animation: isDone
                      ? "shield-pulse 1200ms ease-in-out infinite"
                      : "none",
                    transformOrigin: "center",
                  }}
                >
                  <Shield size={90} color={isDone ? GREEN : ORANGE} />
                </div>
